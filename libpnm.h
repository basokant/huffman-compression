...
/* A PBM IMAGE */
/*-------------*/
struct PBM_Image { // the image dimensions
  int width, height;
...
/* A PGM IMAGE */
/*-------------*/
struct PGM_Image { // the image dimensions
  int width, height;
...
/* A PPM IMAGE */
/*-------------*/
struct PPM_Image { // the image dimensions
  int width, height;
...
/*-------------------------------------------------*/
int create_PGM_Image(struct PGM_Image *pgmImage, int width, int height,
                     int maxGrayValue);
...
/*-------------------------------------------------*/
int create_PPM_Image(struct PPM_Image *ppmImage, int width, int height,
                     int maxGrayValue);
...
int copy_3_PGM_to_PPM(struct PGM_Image *pgmImage_R,
                      ...
                      struct PGM_Image *pgmImage_B, struct PPM_Image *ppmImage);
...
/*-----------------------------------*/
int copy_PPM_to_PBM(struct PPM_Image *ppmImage, struct PBM_Image *pbmImage,
                    enum Color color);

/*-----------------------------------*/
/* COPIES A PPM IMAGE TO A PGM IMAGE */
/*-----------------------------------*/
int copy_PPM_to_PGM(struct PPM_Image *ppmImage, struct PGM_Image *pgmImage,
                    enum Color color);

/*-----------------------------------------------------------*/
/* CONVERTS A PPM IMAGE TO A PGM IMAGE USING THE Y COMPONENT */
/*-----------------------------------------------------------*/
int convert_PPM_to_PGM(struct PPM_Image *ppmImage, struct PGM_Image *pgmImage);
